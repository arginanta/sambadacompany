            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.statistics.update', $statistic) }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ $statistic->name }}" required
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="goal" class="block mt-1 w-full" type="text" name="goal" value="{{ $statistic->goal }}" required
